...
$sBNCode = 'none';	
	...
	*/
	...
	//define ('RETURN_URL', 'http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].$_SERVER['REQUEST_URI']);
	if(SHOP_CHECKOUT_WITH_HTTPS)
	{
		define ('RETURN_URL', 'https://'.$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']);	
	}
	else
	{
		define ('RETURN_URL', 'http://'.$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']);
	}

	define ('CANCEL_URL', 'http://'.$_SERVER['SERVER_NAME'].'/modules/pay_gate/paypal_return_canx.php?p='.SHOP_PAGE_ID);
	...
	*/
	function hash_call($methodName,$nvpStr)
	{
	   ...
	   //Set proxy name to PROXY_HOST and port number to PROXY_PORT in constants.php 
		...
		$nvpreq="METHOD=" . urlencode($methodName) . "&VERSION=" . urlencode(PAYPAL_API_VERSION) . "&PWD=" . urlencode(PAYPAL_API_PASSWORD) . "&USER=" . urlencode(PAYPAL_API_USERNAME) . "&SIGNATURE=" . urlencode(PAYPAL_API_SIGNATURE) . $nvpStr;
