<?php
	...
	if (isset($_GET['printinv']) AND $_GET['printinv'] != '')
	{
		...
		//require_once ('shop_php_functions.php');	
	...
	$sql_statement = 'SELECT * FROM shop_orders WHERE hash_inv_num = "'.$hash_inv_num.'"';
	...
	else
	{
		...
		{			
			echo TAB_10.'<div class="ShopPrintReceiptButton" >' ."\n";
				...
				echo TAB_11.'<a class="ShopButton" href="/modules/shop/shop_receipt_display.php?printinv='.$hash_inv_num.'"' ."\n";	
