...
// Licensed under the MIT license: http://www.opensource.org/licenses/mit-license.php
		...
		$(document).ready(function(){
			...
			$("a[rel='ColorBoxImage']").colorbox(/* {title:false} */);
			$("a[rel='ColorBoxImageShop']").colorbox(/* {title:false} */);
			$("a[rel='ColorBoxImageBrochure']").colorbox( {title:true} );
			$("a[rel='SiteNewWin']").colorbox({width:"85%", height:"80%", iframe:true, title:false});
			$("a[rel='W3CNewWin']").colorbox({width:"80%", height:"80%", iframe:true, title:false});
			$("a[rel='CaptchaNewWin']").colorbox({width:"600px", height:"400px", iframe:true, title:false});
			$("a[rel='ShopExplainCVN']").colorbox({width:"680px", height:"520px", iframe:true, title:false});
			$("a[rel='EventListMoreInfo1']").colorbox({width:"80%", height:"80%", iframe:true, title:false});
			$("a[rel='EventListMoreInfo2']").colorbox({width:"80%", height:"80%", iframe:true, title:false});
			$("a[rel='EventListMoreInfo3']").colorbox({width:"80%", height:"80%", iframe:true, title:false});
			$("a[rel='ColorBoxLink']").colorbox({width:"90%", height:"90%", iframe:true, title:false});
			$("a[rel='ColorBoxMenuLink']").colorbox({width:"90%", height:"90%", iframe:true, title:false});
			$("a[rel='ColorBoxNewsletter']").colorbox({width:"90%", height:"90%", iframe:true});
			$("a[rel='ColorBoxProfileGallery']").colorbox({width:"80%", height:"80%"});
			
			
			$("a[rel='CMS_ColorBox_EditModData']").colorbox({width:"90%", height:"90%", iframe:true, title:false 
				//,onClosed:function(){ location.reload(true); }
				});

			$("a[rel='CMS_ColorBox_AddCloneModData']").colorbox({width:"90%", height:"90%", iframe:true, title:false
				//,onClosed:function(){ location.reload(true); }
				});	
				
			$("a[rel='CMS_ColorBox_EditAddClonePage']").colorbox({width:"90%", height:"90%", iframe:true, title:false
				//,onClosed:function(){ location.reload(true); }
				});	
				
			$("a[rel='CMS_ColorBox_EditChangeModType']").colorbox({width:"90%", height:"90%", iframe:true, title:false
				//,onClosed:function(){ location.reload(true); }
				});		
				
				
			$("a[rel='CMS_ColorBox_EditGlobalSettings']").colorbox({width:"90%", height:"90%", iframe:true, title:false
				,onClosed:function(){ location.reload(true); }
				});	

			$("a[rel='CMS_ColorBox_EditShopItem'], a[rel='CMS_ColorBox_EditShopItemName'], a[rel='CMS_ColorBox_EditShopItemCode'], a[rel='CMS_ColorBox_EditShopItemImage'], a[rel='CMS_ColorBox_EditShopItemDelete'], a[rel='CMS_ColorBox_EditShopCat']").colorbox({width:"90%", height:"90%", iframe:true, title:false, 
				onClosed:function(){ location.reload(true); }
				});
				
			$("a[rel='CMS_ColorBox_EditEvent'], a[rel='CMS_ColorBox_EditEventImage']").colorbox({width:"90%", height:"90%", iframe:true, title:false, 
				onClosed:function(){ location.reload(true); }
				});
				
			$("a[rel='CMS_ColorBox_EditProfile'], a[rel='CMS_ColorBox_EditProfile-Name'], a[rel='CMS_ColorBox_EditProfile-Image']").colorbox({width:"90%", height:"90%", iframe:true, title:false, 
				onClosed:function(){ location.reload(true); }
				});				
